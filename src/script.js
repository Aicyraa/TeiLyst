...
import { countTodo, getAllCategory, getAllTags } from "./todo/Todo.utilities.js";
...
const todos = [
   ...
   new Todo("Read Clean Code", "Learning", "Finish chapters 5 through 8", "2026-03-01", "pending", "Chapter 5,Chapter 6,Chapter 7,Chapter 8", "books,self-improvement", "low"),
